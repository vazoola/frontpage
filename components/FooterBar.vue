<template lang="html">
    <footer>
        <div class="container">
            <div class="columns">
                <div class="column is-2 footer-class">
                    <span>
                        <p>© {{ new Date().getFullYear() }} VAZOOLA</p>
                    </span>
                </div>
                <div class="column is-3 footer-class">
                    <span>
