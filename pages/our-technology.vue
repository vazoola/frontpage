...
<div>
	...
	<section class="services">
        <div class="container">
            <div class="columns">
                <div class="column">
                    <img src="/images/content-img.png" alt="Content Library">
                </div>
                <div class="column">
                    <div class="headline">
    ...
    <!-- start: Proposals -->
    <section class="services right-img">
        <div class="container">
            <div class="columns">
                <div class="column">
                    <div class="headline">
                ...
                <div class="column">
                    <img src="/images/proposals.png" alt="Proposals">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="services">
        <div class="container">
            <div class="columns">
                <div class="column">
                    <img src="/images/campaign-img.png" alt="Campaign Tracking">
                </div>
                <div class="column">
                    <div class="headline">
